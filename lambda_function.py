...
from repository.wallpaper_repository import WallpaperRepository
...
def lambda_handler(event, context):
    ...
    music_repository = MusicRepository(user_id, project_id)
    ...
    wallpaper_repository = WallpaperRepository(user_id, project_id)
    ...
    video_impl = VideoImpl(music_repository, wallpaper_repository)
